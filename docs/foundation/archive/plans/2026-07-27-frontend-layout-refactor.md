...
当前 `AppSidebar` 在所有视口均使用 `position: fixed`，内容区再以 `lg:pl-[280px]` 补偿。两套相互独立的几何规则容易在断点、样式装载或嵌入式视口下失配。实现依据 `docs/archive/design/frontend-shell.md`、`docs/archive/design/dynamic-navigation-and-branding.md`、ADR-0008 和 ADR-0012。
...
- `docs/archive/ai-logs/2026/07/2026-07-27-frontend-layout-refactor.md`
