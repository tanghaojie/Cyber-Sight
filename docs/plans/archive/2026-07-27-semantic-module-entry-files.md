...
现有 ADR-0009 强制模块通过 `index.ts` 公开能力，但仓库代码规范要求尽量避免这类无语义文件名。最终边界规则见 `docs/design/module-boundaries.md`，入口命名调整由 ADR-0013 记录。
...
- `docs/ai-logs/2026/07/2026-07-27-semantic-module-entry-files.md`
