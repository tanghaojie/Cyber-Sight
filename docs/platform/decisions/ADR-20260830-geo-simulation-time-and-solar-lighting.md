...
- 首版动态光照包含太阳驱动的地球光照与太阳阴影。地球光照默认开启；阴影因 GPU 成本默认关闭并提供独立开关；不实现月光、人工光源、天气或大气散射模拟。2026-09-11 的[外部模型统一渲染决策](ADR-20260911-geo-external-model-rendering.md)扩展模型昼夜材质、环境光和模型太阳直射的统一控制；单一 Clock 和 Scene 所有权保持不变，地球光照开关不承担模型窗灯开关语义。
