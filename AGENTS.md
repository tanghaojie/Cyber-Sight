...
- `README.md`、产品品牌、公开 URL、`src/modules/biz/**` 和 `docs/platform/design/upstream-synchronization.md` 由 Cyber-Sight 拥有；冲突时保留下游产品事实并人工移植适用的上游内容。未定制系统模块和通用脚手架修复优先采用上游实现。
