...
import { createApplicationHttpErrorHandler } from '@/foundation/api/applicationHttpError'
import { installGlobalHttpErrorHandler } from '@/foundation/api/globalHttpError'
