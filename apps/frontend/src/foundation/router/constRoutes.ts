import { loginPage } from '@/foundation/modules/auth/auth.routes'
import { noAccessPage, notFoundPage } from '@/foundation/modules/errors/error.routes'
import AdminLayout from '@/foundation/layouts/AdminLayout.vue'
import { RouteRecordRaw } from 'vue-router'
import { personalProfilePage } from '@/foundation/modules/users/profile.routes'
