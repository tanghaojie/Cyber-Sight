...
import { useSettingsStore, type ThemeColor } from '@/foundation/modules/settings/settings.store'
import { THEME_COLOR_OPTIONS } from '@/foundation/modules/settings/settings.theme'
