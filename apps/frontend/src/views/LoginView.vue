...
.visual-panel { position: relative; overflow: hidden; min-height: 100vh; color: #fff; background: radial-gradient(circle at 15% 10%, #383c68 0, transparent 36%), linear-gradient(145deg, #1d2035 0%, #111321 72%); }
...
.logo-mark { width: 36px; height: 36px; display: grid; place-items: center; border-radius: 10px; color: #fff; background: linear-gradient(145deg, #7a7af0, #5151bd); font-size: 15px; font-weight: 850; box-shadow: 0 10px 25px rgba(91,91,214,.33); }
.visual-message { max-width: 610px; margin: auto 0; padding: 50px 0; }
.kicker { margin-bottom: 24px; color: #858bd0; font-size: 11px; font-weight: 800; letter-spacing: .22em; }
...
.visual-message h1 em { color: #9292f0; font-style: normal; }
.visual-message p { max-width: 480px; margin: 28px 0 0; color: #858b9e; font-size: 15px; line-height: 1.85; }
.feature-row { display: flex; gap: 28px; margin-top: 45px; color: #a7abba; font-size: 11px; }.feature-row span { display: grid; gap: 7px; }.feature-row b { color: #666da4; font-size: 10px; letter-spacing: .12em; }
.copyright { color: #464b5e; font-size: 9px; letter-spacing: .13em; }
.orb { position: absolute; z-index: 1; border-radius: 50%; filter: blur(1px); }.orb-one { right: -120px; top: 18%; width: 310px; height: 310px; border: 1px solid rgba(136,136,240,.2); box-shadow: inset 0 0 70px rgba(105,105,218,.08); }.orb-two { left: 44%; bottom: -150px; width: 390px; height: 390px; background: radial-gradient(circle, rgba(83,83,190,.16), transparent 68%); }
.form-panel { display: grid; place-items: center; padding: 56px 9%; background: radial-gradient(circle at 90% 0, #f6f5ff, transparent 40%), #fff; }
...
.login-button { min-height: 52px; display: flex; align-items: center; justify-content: space-between; margin-top: 5px; padding: 0 18px 0 22px; border: 0; border-radius: 12px; color: #fff; background: linear-gradient(135deg, #6666df, #5050bb); font-weight: 700; box-shadow: 0 13px 30px rgba(80,80,185,.24); transition: 170ms; }.login-button:hover { transform: translateY(-1px); box-shadow: 0 16px 34px rgba(80,80,185,.3); }.login-button:disabled { opacity: .65; transform: none; }
