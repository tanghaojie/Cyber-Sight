...
const records: MenuSummary[] = [
  { ...audit, id: 2, parentId: 1, name: '用户管理', code: 'USERS', path: '/users', component: 'users', externalUrl: '', icon: 'users', sortOrder: 10, type: 'menu', enabled: true },
  { ...audit, id: 1, parentId: 0, name: '组织与权限', code: 'ORGANIZATION', path: '', component: '', externalUrl: '', icon: 'layers', sortOrder: 5, type: 'directory', enabled: true },
]
