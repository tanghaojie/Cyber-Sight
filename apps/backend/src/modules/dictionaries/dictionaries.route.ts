...
import {
  DictionaryPageResultSchema, DictionaryRequestSchema, EmptyResultSchema, ErrorResponseSchema,
...
export async function dictionaryRoutes(app: FastifyInstance): Promise<void> {
  app.get<{ Querystring: ListQuery }>('/admin/dictionaries', {
    schema: { operationId: 'listDictionaries', tags: ['Dictionaries'], querystring: toFastifySchema(ListQuerySchema), response: { 200: toFastifySchema(DictionaryPageResultSchema), default: toFastifySchema(ErrorResponseSchema) } },
  ...
  app.post<{ Body: DictionaryRequest }>('/admin/dictionaries', {
    schema: { operationId: 'createDictionary', tags: ['Dictionaries'], body: toFastifySchema(DictionaryRequestSchema), response: { 200: toFastifySchema(MutationResultSchema), default: toFastifySchema(ErrorResponseSchema) } },
  ...
  app.put<{ Params: IdParams; Body: DictionaryRequest }>('/admin/dictionaries/:id', {
    schema: { operationId: 'updateDictionary', tags: ['Dictionaries'], params: toFastifySchema(IdParamsSchema), body: toFastifySchema(DictionaryRequestSchema), response: { 200: toFastifySchema(MutationResultSchema), default: toFastifySchema(ErrorResponseSchema) } },
  ...
  app.delete<{ Params: IdParams }>('/admin/dictionaries/:id', {
    schema: { operationId: 'deleteDictionary', tags: ['Dictionaries'], params: toFastifySchema(IdParamsSchema), response: { 200: toFastifySchema(EmptyResultSchema), default: toFastifySchema(ErrorResponseSchema) } },
