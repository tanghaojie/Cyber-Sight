...
export async function userRoutes(app: FastifyInstance): Promise<void> {
  app.get<{ Querystring: ListQuery }>('/admin/users', {
    schema: {
      operationId: 'listUsers', tags: ['Users'], querystring: toFastifySchema(ListQuerySchema),
      response: { 200: toFastifySchema(UserPageResultSchema), default: toFastifySchema(ErrorResponseSchema) },
    },
  ...
  app.post<{ Body: UserCreate }>('/admin/users', {
    schema: {
      operationId: 'createUser', tags: ['Users'], body: toFastifySchema(UserCreateSchema),
  ...
  app.put<{ Params: IdParams; Body: UserUpdate }>('/admin/users/:id', {
    schema: {
      operationId: 'updateUser', tags: ['Users'], params: toFastifySchema(IdParamsSchema), body: toFastifySchema(UserUpdateSchema),
      response: { 200: toFastifySchema(MutationResultSchema), default: toFastifySchema(ErrorResponseSchema) },
    },
  ...
  app.delete<{ Params: IdParams }>('/admin/users/:id', {
    schema: {
      operationId: 'deleteUser', tags: ['Users'], params: toFastifySchema(IdParamsSchema),
